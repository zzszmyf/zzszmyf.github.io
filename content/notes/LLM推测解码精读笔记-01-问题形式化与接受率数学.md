---
title: "投机采样为什么是无损的？接受率与期望 token 公式推导"
date: 2026-08-17T00:00:00+08:00
draft: false
description: "自回归解码慢的结构性原因是因果依赖浪费了 GPU 并行能力，「草稿 + 并行验证」正好把它补回来。本文从定义推导期望接受 token 数 E[N]=(1-α^(K+1))/(1-α) 与墙钟加速比公式，并解释拒绝采样后输出分布为何依然无损。"
weight: 31
tags: ["LLM推理优化", "推测解码"]
---

> 系列导航：上篇系列 [LLM 量化精读笔记总览](/notes/llm量化精读笔记-00-总览与学习地图/)｜[推测解码精读笔记总览](/notes/llm推测解码精读笔记-00-总览与学习地图/)（共 6 篇）｜下一篇：[投机采样原理是什么](/notes/llm推测解码精读笔记-02-原始推测解码-草稿模型与拒绝采样/)
